...
class _bioCardState extends State<bioCard> {
  ...
  String jpText =
      '''日本の大学で経済学を学ぶ03s。トビタテ高校5期未来テクノロジー人材枠。 “誰もが生きる『おもしろさ』を感じることができる社会”を目指し、映像・アプリ・ゲームなどを制作。目指すべき社会(目的)を明確にするため、大学では経済学を専攻。一番得意なツールはパワポ。最近、K-popの沼にダイブしてしまった。助けて。''';
  String koreText =
          ...
          //自己紹介_テキスト
           Expanded(
                ...
                child: Container(
                  ...
                  padding: EdgeInsets.only(left: 0.0 ,top: 1.0, right: 15.0, bottom: 0.0),
                  child: Text(
                    //英語の場合
