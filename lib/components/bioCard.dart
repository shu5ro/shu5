...
class _bioCardState extends State<bioCard> {
  ...
  String jpText =
      '''日本の大学で経済学を学ぶ03s。トビタテ留学JAPAN高校生コース5期未来テクノロジー人材枠。 “誰もが生きる『おもしろさ』を感じることができる社会”を目指し、映像・アプリ・ゲームなどを制作。目指すべき社会(目的)を明確にするため、大学では経済学を専攻。デジタルエンターテイメント×社会問題解決でソリューションを模索中(ざっくり表現すると)。一番得意なツールはパワポ。最近、K-popの沼にダイブしてしまった。助けて。''';
  String koreText =
